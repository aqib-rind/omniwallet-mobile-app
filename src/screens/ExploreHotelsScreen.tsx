...
export default function ExploreHotelsScreen() {
    ...
    const AddRoomPressesd = () => { }
        ...
        const onNextPress = () => {
            navigation.navigate('HotelsListScreen', {adults:adults, kids:kids, startDate:selectedStartDate, endDate:selectedEndDate});
        }
    ...
    return (
        <SafeAreaView style={styles.Body}>
             <View className=" flex-row h-16 w-full justify-start items-center">
                ...
                <Text className="text-primary text-[18px] leading-5  " style={{ fontFamily: 'Rubik-Medium' }}>Stays</Text>
            </View>
                ...
                <ScrollView style={{ width: '100%', flex: 1 }} showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableOpacity style={styles.DatePickerView} onPress={() => setModalVisible(true)} >
                        ...
                        <View style={styles.DatePickerTextView}>
                            ...
                            <Text style={styles.DPBottomText}>{adults} Traveller, {kids} Childern, 1 room  </Text>
                        </View>
                    </TouchableOpacity>
