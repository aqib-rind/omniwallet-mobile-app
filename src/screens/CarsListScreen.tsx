...
import CarCard from '../utils/components/CarCard';
...
const CarsListScreen:React.FC<Props> = () => {
    ...
    return (
        <SafeAreaView style={styles.Body}>
            <View className=" flex-row h-16 w-full justify-start items-center">
                ...
                <Text className="text-primary text-[18px] leading-5  " style={{ fontFamily: 'Rubik-Medium' }}>Cars</Text>
            </View>
            <View style={styles.container}>
                <ScrollView style={{ width: '100%', flex: 1 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.HotelView}>
                        <CarCard imageSource='' description='' onPress={()=>{} } title=''/>
                        <CarCard imageSource='' description='' onPress={()=>{} } title=''/>
                        <CarCard imageSource='' description='' onPress={()=>{} } title=''/>
                        <CarCard imageSource='' description='' onPress={()=>{} } title=''/>
                    </View>
