...
export default function ExploreCarsScreen() {
    ...
    const AddRoomPressesd = () => { }
        ...
        const [pickupDate, setPickupDate] = useState('DD/MM/YYYY');
        ...
        <SafeAreaView style={styles.Body}>
            <View style={styles.header}>
                ...
                <View style={styles.textView}>
                    <Text className={"text-primary px-5 text-[18px]"}style={{fontFamily:'Rubik-Medium'}}>Cars</Text>
                </View>
            </View>
            <View style={styles.container}>
                <ScrollView style={{ width: '100%', flex: 1 }} showsVerticalScrollIndicator={false}>
                    <TouchableOpacity style={styles.searchView} >
                        <View><Image source={require('../utils/assets/pin.png')} tintColor={'#0C0C3A'} style={styles.searchIcon} /></View>
                        <TextInput placeholder="Pickup Location" style={styles.searchInput} placeholderTextColor={"#8E8E8E"} cursorColor={'#0C0C3A'} />
                    </TouchableOpacity>
                    <View className={"w-full flex-1 flex-row"}>
                    <TouchableOpacity style={[styles.DatePickerView,{marginRight:vw(1)}]} onPress={() => setCalendarModal(true)} >
                        <View><Image source={require('../utils/assets/calender.png')} style={styles.calendarIcon} /></View>
                        <View style={styles.DatePickerTextView}>
                            <Text style={styles.DPTopText}>Pickup Date</Text>
                            <Text style={styles.DPBottomText}></Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.searchView} >
                        <View><Image source={require('../utils/assets/pin.png')} tintColor={'#0C0C3A'} style={styles.searchIcon} /></View>
                        <TextInput placeholder="Drop-off Location" style={styles.searchInput} placeholderTextColor={"#8E8E8E"} cursorColor={'#0C0C3A'} />
                    </TouchableOpacity>
                ...
                <View style={styles.modalContainer} >
                    <View style={styles.modalContent}>
                        ...
                        <CalendarPicker
                            ...
                            // onDateChange={setPickupDate(Date)}
                            width={vw(80)}
                            height={vh(50)}
                            previousTitle="Prev"
